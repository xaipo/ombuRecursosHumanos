...
var routeExample = require('../Models/HorarioTrabajoModel'); //copiar el modelo de la tabla
...
routeExample.register(router,'/horarioTrabajo'); //nombre ruta para acceder por web
