...
var routeExample = require('../Models/EvaluacionDesempenoModel'); //copiar el modelo de la tabla
...
routeExample.register(router,'/evaluacionDesempeno'); //nombre ruta para acceder por web
