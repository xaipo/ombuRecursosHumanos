...
var routeExample = require('../Models/PerfilTrabajoModel'); //copiar el modelo de la tabla
...
routeExample.register(router,'/perfilTrabajo'); //nombre ruta para acceder por web
