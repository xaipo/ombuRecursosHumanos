/**
 * Created by VICTOR OQUENDO on 10/30/2017.
 */
...
var routeExample = require('../Models/modeloExample'); //copiar el modelo de la tabla
...
routeExample.register(router,'/example'); //nombre ruta para acceder por web
