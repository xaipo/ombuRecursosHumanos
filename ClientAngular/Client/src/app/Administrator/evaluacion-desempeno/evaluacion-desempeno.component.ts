...
import {EvaluacionDesempeno} from '../../models/evaluacion-desempeno';
...
export class EvaluacionDesempenoComponent implements OnInit {
  ...
  public actual:EvaluacionDesempeno;
  public selected:EvaluacionDesempeno;
  public listado:any;
  ...
  constructor(private _route:ActivatedRoute,
              ...
              private _induccionService:EvaluacionDesempenoService,
              private _categoriaTrabajoService:CategoriaTrabajoService) {
    this.actual = new EvaluacionDesempeno(this.any, this.any, '',  []);
    this.listado = [];
    this.getAll();
  }
...
cloneObj(obj:EvaluacionDesempeno):EvaluacionDesempeno {
...
class PrimeObj implements EvaluacionDesempeno {
